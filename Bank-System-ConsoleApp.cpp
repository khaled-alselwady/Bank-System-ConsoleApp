...
long int RandomNumber(long int From, long int To)
{
    long int Random = rand() % (To - From + 1) + From;
    return Random;
}

string GetNewSecurityCode()
{
    return to_string(RandomNumber(1645947526, 9748536186) + RandomNumber(500000000, 900000000));
}
